      ...
      <tbody>
        {jobsApplied.map((job, index) => true ? (
          <tr>
            ...
            <td className="py-2 x-4 border-b">{job.title}</td>
            <td  className="py-2 x-4 border-b max-sm:hidden">{job.location}</td>
            <td  className="py-2 x-4 border-b max-sm:hidden">{moment(job.date).format('ll')}</td>
            <td  className="py-2 x-4 border-b">
